...
const modelsWithSoftDelete = ["Group", "GroupLeader", "PersonRole", "WorkAssignment", "TrainingModule", "ModuleReport", "TrainingReport", "TrainingEvaluation","EvaluationInstrument"];
